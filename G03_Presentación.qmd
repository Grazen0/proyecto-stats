...
| **PDias**                           |      cuantitativa discreta      | Mayor o igual a $0$ o igual a $-1$.                 |
...
$$
\mathbb{P}(\text{primaria}) + P(\text{secundaria}) + P(\text{terciario}) = \frac{331}{2239} + \frac{1247}{2239} + \frac{661}{2239} = \frac{2239}{2239} = 1.
$$
...
$$
\mathbb{P}(\text{1 contacto}) + \ldots + P(\text{Más de 10 contactos}) = \frac{869}{2239} + \ldots + \frac{67}{2239} = \frac{2239}{2239} = 1
.$$
